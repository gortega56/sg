...
sg_u8 sg_hash_table_find(sg_hash_table* p_table, sg_u32 key, void** pp_value);
...
inline sg_u8 hash_table_type##_find(hash_table_type* p_table, sg_u32 key, element_type** pp_element) { return sg_hash_table_find(p_table, key, (void**)pp_element); }\
